...
{
    public class LojaAStrategy : IProdutoLojaStrategy
    {
        private readonly ProdutoRepository _produtoRepository;
        private readonly ProdutoLojaRepository _produtoLojaRepository;
        private readonly CategoriaRepository _categoriaRepository;

        public LojaAStrategy(ProdutoRepository produtoRepository, ProdutoLojaRepository produtoLojaRepository, CategoriaRepository categoriaRepository)
        {
        ...
        public async Task<ProdutoViewModel?> Build(int produtoId)
        {
            ...
            return new ProdutoViewModel
            {
                ...
                InfoPorLoja = produtoLoja.Select(pl => new ProdutoLojaViewModel
                {
                    ...
                    Preco = pl.preco // Loja A usa o preço normal
                }).ToList()
            };
        }
    }
