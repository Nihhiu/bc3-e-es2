...
//         throw new ValidationException("O nome do produto não pode ser nulo ou vazio.");

//         var caracteresProibidos = "«»'?!\"#$/=?'[]{}´`ºª~^,.;_\\><";
//         if (produto.Nome.Any(c => caracteresProibidos.Contains(c)))
//             throw new ValidationException("O nome do produto contém caracteres inválidos.");
